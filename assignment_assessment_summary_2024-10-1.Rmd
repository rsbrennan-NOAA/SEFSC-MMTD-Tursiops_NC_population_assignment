...
Overall, there is decent population structure:

![](figures/pca.png){width=70%}
...
![](figures/assignment_rates_proportionIndivs.png)


### Fixed number of individuals in training set

![](figures/assignment_rates_fixedIndivs.png)


### look only at svm:

![](figures/assignment_rates_svm.png){width=70%}
...
Overall, accuracy is worse. Tested with 80% training testing partitioning and again subsetting to 10 indivs for training.

![](figures/dapc_allindivs_accuracy.png){width=50%}
![](figures/dapc_fixedindiv_accuracy.png){width=50%}
